...
export const TRAZOS = {
  ...
  palette:
    'M12 3a9 9 0 1 0 0 18c1.2 0 1.8-.9 1.8-1.8 0-.5-.2-.9-.5-1.2-.3-.3-.5-.7-.5-1.2 0-1 .8-1.8 1.8-1.8H16a5 5 0 0 0 5-5c0-3.9-4-7-9-7zM7.5 12.5h.01M9 8h.01M13.5 7h.01M17 10h.01',
} as const
