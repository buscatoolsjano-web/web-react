...
/**
 * Los hermanos del producto: misma marca, misma serie, mismo tipo.
 *
 ...
 *
 * Los que comparten la raíz del código —`SP.2520/8B` y `SP.2520/10B`— vienen
 * primero, porque son la misma pieza en otra medida.
 */
  ...
  if (productos.length === 0) {
    return (
      <p className={styles.vacio}>
        Sin productos relacionados. Se muestran los de la misma marca, serie y tipo.
      </p>
    )
  }
