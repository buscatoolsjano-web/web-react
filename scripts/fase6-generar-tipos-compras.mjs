/**
 * Fase 6 · Compras — genera los bloques de tipos de las tablas de Compras.
 *
 ...
 *   node scripts/fase6-generar-tipos-compras.mjs            # imprime
 *   node scripts/fase6-generar-tipos-compras.mjs --escribir # parchea
 */
