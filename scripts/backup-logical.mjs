...
async function main() {
  ...
  const partes = [
    ...
    '--   contraseñas no son exportables. Al restaurar hay que recrear los',
    '--   7 usuarios; el trigger on_auth_user_created regenera sus profiles,',
    '--   y las membresías de este archivo los vuelven a vincular por id.',
    '-- ═══════════════════════════════════════════════════════════════',
    '',
    'BEGIN;',
    '',
