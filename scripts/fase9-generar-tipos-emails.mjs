/**
 * Fase 9 · Emails — genera los bloques de tipos de sus seis tablas.
 *
 ...
 * oficial.
 *
 * Emite los bloques `Tables` de las seis tablas de Emails, listos para
 ...
 *   · `isOneToOne: false` en todas: ninguna FK de Emails tiene un índice
 *     único sobre exactamente sus columnas.
 *
 *   set -a; source .env; source .env.migration; set +a
 *   node scripts/fase9-generar-tipos-emails.mjs            # imprime
 *   node scripts/fase9-generar-tipos-emails.mjs --escribir # parchea
 */
